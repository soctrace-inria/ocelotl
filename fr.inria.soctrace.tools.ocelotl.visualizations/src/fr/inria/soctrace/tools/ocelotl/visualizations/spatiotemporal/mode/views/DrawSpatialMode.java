...
import fr.inria.soctrace.tools.ocelotl.visualizations.spatiotemporal.partition.views.SpatiotemporalPartitionView;
...
public class DrawSpatialMode {
	...
	private SpatiotemporalMode proportion;

	public DrawSpatialMode(SpatiotemporalMode proportion,
	...
	private void drawStandardAggregate(int logicX, int logicY, int logicX2,
		...
		MainState state = proportion.getMajState(epn, logicX, logicX2);
