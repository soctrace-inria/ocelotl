...
public class StatProducer extends StatView {
	 ...
	 * Logger
	 */
	private final static Logger logger = LoggerFactory.getLogger(StatProducer.class);
	 ...
	 * Constructor
	 */
	public StatProducer(OcelotlView theView) {
		super(theView);
		showTrace();
	}
