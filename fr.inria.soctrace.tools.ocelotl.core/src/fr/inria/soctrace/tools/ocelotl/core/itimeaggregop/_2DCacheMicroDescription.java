...
public abstract class _2DCacheMicroDescription extends CacheTimeAggregationOperator implements I2DMicroDescription {

	protected List<HashMap<String, Long>>	matrix;

	public _2DCacheMicroDescription() throws SoCTraceException {
		super();
	}

	public _2DCacheMicroDescription(final OcelotlParameters parameters) throws SoCTraceException {
		super();
		try {
