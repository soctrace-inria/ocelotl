...
public class PartAggregation {
	...
	public PartAggregation(final OcelotlCore lpaggregCore) {
		super();
	...
	public void print() {
		...
		System.out.println("Aggregation operator: " + lpaggregCore.getOcelotlParameters().getAggOperator());
