...
public class OLPAggregWrapper {
	...
	public double getGainByIndex(int index) {
		return lpaggregJNI.OLPAggregWrapper_getGainByIndex(swigCPtr, this,
				index);
	}

	public double getGainByParameter(float parameter) {
		return lpaggregJNI.OLPAggregWrapper_getGainByParameter(swigCPtr, this,
				parameter);
	}

	public double getLossByIndex(int index) {
		return lpaggregJNI.OLPAggregWrapper_getLossByIndex(swigCPtr, this,
				index);
	}

	public double getLossByParameter(float parameter) {
		return lpaggregJNI.OLPAggregWrapper_getLossByParameter(swigCPtr, this,
				parameter);
	}

	public void computeQualities(boolean normalization) {
		lpaggregJNI.OLPAggregWrapper_computeQualities(swigCPtr, this,
				normalization);
	}
	...
	public void computeDichotomy(float threshold) {
		lpaggregJNI
				.OLPAggregWrapper_computeDichotomy(swigCPtr, this, threshold);
	}
	...
	public void setValue(int i, int j, double value) {
		lpaggregJNI.OLPAggregWrapper_setValue__SWIG_1(swigCPtr, this, i, j,
				value);
	}

	public void push_back(int i, double value) {
		lpaggregJNI
				.OLPAggregWrapper_push_back__SWIG_1(swigCPtr, this, i, value);
	}
	...
	public void setValue(int i, int j, int k, double value) {
		lpaggregJNI.OLPAggregWrapper_setValue__SWIG_2(swigCPtr, this, i, j, k,
				value);
	}
	...
	public void push_back(int i, int j, double value) {
		lpaggregJNI.OLPAggregWrapper_push_back__SWIG_2(swigCPtr, this, i, j,
				value);
	}
