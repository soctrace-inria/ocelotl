...
public class DLPAggregWrapper {
	...
	public boolean hasFullAggregation(int id) {
		return lpaggregJNI.DLPAggregWrapper_hasFullAggregation(swigCPtr, this,
				id);
	}
	...
	public double getGainByIndex(int index) {
		return lpaggregJNI.DLPAggregWrapper_getGainByIndex(swigCPtr, this,
				index);
	}

	public double getGainByParameter(double parameter) {
		return lpaggregJNI.DLPAggregWrapper_getGainByParameter(swigCPtr, this,
				parameter);
	}

	public double getLossByIndex(int index) {
		return lpaggregJNI.DLPAggregWrapper_getLossByIndex(swigCPtr, this,
				index);
	}

	public double getLossByParameter(double parameter) {
		return lpaggregJNI.DLPAggregWrapper_getLossByParameter(swigCPtr, this,
				parameter);
	}

	public void computeQualities(boolean normalization) {
		lpaggregJNI.DLPAggregWrapper_computeQualities(swigCPtr, this,
				normalization);
	}
	...
	public void computeDichotomy(float threshold) {
		lpaggregJNI
				.DLPAggregWrapper_computeDichotomy(swigCPtr, this, threshold);
	}

	public void setValue(int id, int i, double value) {
		lpaggregJNI.DLPAggregWrapper_setValue__SWIG_0(swigCPtr, this, id, i,
				value);
	}

	public void push_back(int id, double value) {
		lpaggregJNI.DLPAggregWrapper_push_back__SWIG_0(swigCPtr, this, id,
				value);
	}
	...
	public void setValue(int id, int i, int j, double value) {
		lpaggregJNI.DLPAggregWrapper_setValue__SWIG_1(swigCPtr, this, id, i, j,
				value);
	}

	public void push_back(int id, int i, double value) {
		lpaggregJNI.DLPAggregWrapper_push_back__SWIG_1(swigCPtr, this, id, i,
				value);
	}
