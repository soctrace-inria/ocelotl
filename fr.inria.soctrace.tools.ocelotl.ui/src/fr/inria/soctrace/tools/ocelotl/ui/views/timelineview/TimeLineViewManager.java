...
public class TimeLineViewManager {
	...
	public IAggregatedView create() {
		...
		try {
			...
			timeLineView = (IAggregatedView) mybundle.loadClass(ocelotlView.getCore().getVisuOperators().getSelectedOperatorResource().getVisualization()).getDeclaredConstructor(OcelotlView.class).newInstance(ocelotlView);
